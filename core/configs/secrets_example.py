...
AZ_CLIENT_SECRET =  "your_super_client_secret" # fron your app Certificates & secrets in Azure Portal
AZ_TENANT_ID = "your tenant Id"  
AZ_AUTHORITY_URL = f"https://login.microsoftonline.com/{AZ_TENANT_ID}"
